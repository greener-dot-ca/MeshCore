...
struct NodePrefs {  // persisted to file
  ...
  uint8_t  buzzer_mode;      // new-message notification sound: 0=CTU ring, 1=beep, 2=morse hop count
  uint8_t  pkt_tones;        // 1 = chirp a per-type tone for every packet the radio decodes
